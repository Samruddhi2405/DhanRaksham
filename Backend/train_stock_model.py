...
# Generate features
investment_amount = np.random.uniform(1000, 1000000, n_samples)  # Investment amounts from ₹1,000 to ₹10,00,000
num_stocks = np.random.randint(1, 100, n_samples)  # Number of stocks from 1 to 100
...
risk_multiplier = np.array([0.8, 1.2, 1.6])[risk_numerical]  # Different multipliers for risk levels
amount_factor = investment_amount / 1000000  # Normalize amount
stocks_factor = num_stocks / 50  # Normalize number of stocks
